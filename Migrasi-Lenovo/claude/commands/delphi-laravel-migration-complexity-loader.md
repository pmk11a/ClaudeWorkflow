...
**This complexity scoring is automatically used in ADW!**
...
ADW performs:
- ✅ Complexity assessment (using this scoring algorithm)
- ✅ Loads only needed skill files based on complexity
- ✅ Optimizes token usage (same logic as below)

**For detailed scoring logic and manual assessment, see below.**
