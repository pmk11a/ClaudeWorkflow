...
**Time:** 30-60 minutes | **~5 minutes with ADW**

---

## ⚡ ADW Automation Notice

**This entire Phase 0 is automated in ADW!**

```bash
./scripts/adw/adw-migration.sh <MODULE>
```

ADW automatically performs all Phase 0 discovery tasks:
- ✅ Validates input files
- ✅ Scans Delphi code structure
- ✅ Assesses complexity (SIMPLE/MEDIUM/COMPLEX)
- ✅ Loads right skill files
- ✅ Generates migration plan
- ✅ Time: ~5 minutes (vs 30-60 manual)

**For manual Phase 0 steps, see below.**
...
ls .claude/skills/delphi-migration/*_MIGRATION_SUMMARY.md
ls ai_docs/lessons/*MIGRATION*.md
```
...
⚠️ **NOTE**: Migration summaries saved to `.claude/skills/delphi-migration/[MODULE]_MIGRATION_SUMMARY.md` (not root)
...
- **Time:** 8-12+ hours
- **See:** `.claude/skills/delphi-migration/SPK_MIGRATION_SUMMARY.md`
